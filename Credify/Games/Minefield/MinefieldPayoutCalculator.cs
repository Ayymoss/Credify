...
/// <summary>
/// Computes Minefield multipliers and payouts using the standard "Mines" formula, adjusted by a configurable
/// house edge (real-world casinos use ~1%, i.e. 0.99). Pure math, no I/O — shared by the chat and web games.
/// </summary>
