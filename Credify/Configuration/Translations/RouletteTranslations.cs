...
public class RouletteTranslations
{
    ...
    public string HowMuchToBet { get; set; } = "(Color::Yellow)Place your bet! (Color::White)You have (Color::Green)${{credits}}";
    public string BetSyntaxHint { get; set; } = "(Color::White)One line: (Color::Accent)<amount> <bet> (Color::White)- e.g. (Color::Accent)500 red(Color::White), (Color::Accent)100 17(Color::White), (Color::Accent)250 d1";
    public string BetSyntaxExtras { get; set; } = "(Color::Accent)bets (Color::White)= see options | (Color::Accent)same (Color::White)= repeat last bet";
    public string BetLegendOutside { get; set; } = "(Color::Yellow)Outside: (Color::White)red black odd even low high";
    public string BetLegendDozensColumns { get; set; } = "(Color::Yellow)Dozens/Columns: (Color::White)d1 d2 d3 c1 c2 c3";
    public string BetLegendInside { get; set; } = "(Color::Yellow)Inside: (Color::White)one number 0-36 or 00 (straight), or 2-6 adjacent numbers";
    public string BetLegendFormat { get; set; } = "(Color::Yellow)Format: (Color::Accent)<amount> <bet> (Color::White)e.g. (Color::Accent)500 red";
    public string NoPreviousBet { get; set; } = "(Color::Yellow)No previous bet to repeat - place one first.";
    public string InvalidBetHint { get; set; } = "(Color::White)Try (Color::Accent)<amount> <bet> (Color::White)e.g. (Color::Accent)500 red(Color::White), or (Color::Accent)bets (Color::White)for options";
    public string TimeWarning { get; set; } = "(Color::Red)10s left to place your bet!";
