...
{
    // @formatter:off
    public string Description { get; set; } = "Join or leave the poker table (Texas Hold'em)";
    ...
    public string AllIn { get; set; } = "(Color::Red)All-in {{amount}} (a)";
    ...
    public string PlayerRaised { get; set; } = "(Color::Red){{name}} (Color::White)raised to (Color::Green)${{amount}}";
    public string PlayerAllIn { get; set; } = "(Color::Red){{name}} (Color::White)went ALL-IN with (Color::Green)${{amount}}";
    ...
    public string PlayerWins { get; set; } = "(Color::Green){{name}} (Color::White)wins (Color::Green)${{amount}} (Color::White)with (Color::Yellow){{hand}}";
