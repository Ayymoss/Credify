...
{
    // @formatter:off
    public string Reward { get; set; } = "[(Color::Pink){{pluginName}}(Color::White)] (Color::Accent){{streak}} (Color::White)kill streak! (Color::Green)+${{reward}}";
    public string Announcement { get; set; } = "[(Color::Pink){{pluginName}}(Color::White)] (Color::Accent){{name}} (Color::White)is on a (Color::Red){{streak}} (Color::White)kill streak!";
