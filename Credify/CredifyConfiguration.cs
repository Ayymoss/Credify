...
public class Translations
{
    ...
    public string ClaimableBetsAvailable { get; set; } = "(Color::Yellow)You have claimable bets. (Color::White)Type (Color::Cyan)!crcb (Color::White)to claim them";
    ...
    public string TopPlayerEntry { get; set; } = "[(Color::Cyan)#{{rank}} (Color::White)@ (Color::Green)${{credits}}(Color::White)] {{name}}";
    public string StatsHeader { get; set; } = "(Color::Cyan)--Global Credit Statistics--";
    public string StatsTotalEarnedCredits { get; set; } = "Total Earned: (Color::Cyan)${{creditsEarned}} (Color::White)credits";
    public string StatsTotalSpentCredits { get; set; } = "Total Spent: (Color::Cyan)${{creditsSpent}} (Color::White)credits";
    public string StatsTotalWonCredits { get; set; } = "Total Won: (Color::Cyan)${{creditsPaid}} (Color::White)credits";
    public string StatsBankCredits { get; set; } = "Bank: (Color::Cyan)${{bankCredits}} (Color::White)credits";
    ...
    public string GambleWon { get; set; } = "You won (Color::Cyan)${{wonAmount}} (Color::White)((Color::Yellow)${{taxed}} (Color::White)taxed) credits! New balance (Color::Cyan)${{newBalance}}";
    public string GambleLost { get; set; } = "You lost (Color::Cyan)${{lostAmount}} (Color::White)((Color::Yellow)${{taxed}} (Color::White)taxed) credits. New balance (Color::Cyan)${{newBalance}}! (Color::Green)Try again! You could win big!";
    public string GambleDraw { get; set; } = "You only lost (Color::White)((Color::Yellow)${{taxed}} (Color::White)taxed) credits. New balance (Color::Cyan)${{newBalance}}! (Color::Green)Better luck next time!";
    public string GambleWonJackpotAnnouncement { get; set; } = "[(Color::Pink){{pluginName}}(Color::White)] (Color::Yellow){{originName}} (Color::White)won the jackpot of (Color::Cyan)${{wonAmount}}! (Color::Yellow){{command}} (Color::White)to play!";
    public string GambleWonAnnouncement { get; set; } = "[(Color::Pink){{pluginName}}(Color::White)] (Color::Yellow){{originName}} (Color::White)won (Color::Cyan)${{wonAmount}}! (Color::Yellow){{command}} (Color::White)to play!";
    ...
    public string ServerBankCredits { get; set; } = "The server bank has (Color::Cyan)${{bankCredits}} (Color::White)credits";
    ...
    public string PaySent { get; set; } = "(Color::Cyan)${{amount}} (Color::White)((Color::Yellow)${{taxed}} (Color::White)taxed) credits sent to (Color::Cyan){{targetName}}";
    public string PayReceived { get; set; } = "(Color::Cyan)${{amount}} credits received from (Color::Cyan){{targetName}}";
    ...
    public string AnnounceLottoWinner { get; set; } = "(Color::Accent){{cleanedName}} (Color::White)won (Color::Green)${{bankCredits}} (Color::White)from the lottery with a (Color::Cyan){{winPct}}(Color::White)pct chance!";
    public string BoughtLottoTickets { get; set; } = "(Color::Cyan){{ticketCount}} (Color::White)lotto tickets bought for (Color::Cyan)${{amount}} (Color::White)credits. You have a total of {{totalTickets}} tickets";
    ...
    public string ShopClientHeader { get; set; } = "(Color::Cyan)--{{name}} - Shop Items--";
    public string ShopServerHeader { get; set; } = "(Color::Cyan)--Shop Items--";
